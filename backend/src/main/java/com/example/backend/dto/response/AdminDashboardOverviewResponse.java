...
public class AdminDashboardOverviewResponse {
    ...
    public void setMaintenanceFields(long maintenanceFields) {
        this.maintenanceFields = maintenanceFields;
    }

    public long getBookedFields() {
        return bookedFields;
    }

    public void setBookedFields(long bookedFields) {
    ...
    public long getDepositPaidBookings() {
        return depositPaidBookings;
    }

    public void setDepositPaidBookings(long depositPaidBookings) {
        this.depositPaidBookings = depositPaidBookings;
    }
    ...
    public long getTotalMatchPosts() {
        return totalMatchPosts;
    }

    public void setTotalMatchPosts(long totalMatchPosts) {
        this.totalMatchPosts = totalMatchPosts;
    }

    public long getOpenMatchPosts() {
        return openMatchPosts;
    }

    public void setOpenMatchPosts(long openMatchPosts) {
        this.openMatchPosts = openMatchPosts;
    }

    public long getMatchedMatchPosts() {
        return matchedMatchPosts;
    }

    public void setMatchedMatchPosts(long matchedMatchPosts) {
        this.matchedMatchPosts = matchedMatchPosts;
    }

    public long getClosedMatchPosts() {
        return closedMatchPosts;
    }

    public void setClosedMatchPosts(long closedMatchPosts) {
        this.closedMatchPosts = closedMatchPosts;
    }

    public long getExpiredMatchPosts() {
        return expiredMatchPosts;
    }

    public void setExpiredMatchPosts(long expiredMatchPosts) {
        this.expiredMatchPosts = expiredMatchPosts;
    }
    ...
    public long getPenalizedReviews() {
        return penalizedReviews;
    }

    public void setPenalizedReviews(long penalizedReviews) {
        this.penalizedReviews = penalizedReviews;
    }
