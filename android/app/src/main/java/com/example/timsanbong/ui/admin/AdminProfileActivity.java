...
public class AdminProfileActivity extends AppCompatActivity {
    ...
    private void setupMenus() {
        // Role switching
        setupMenuItem(findViewById(R.id.menuPlayer), R.drawable.ic_person, "Người chơi", "#F0FDF4", "#166534", false);
        setupMenuItem(findViewById(R.id.menuOwner), R.drawable.ic_admin_stadium, "Chủ sân", "#ECFDF5", "#059669", false);
        setupMenuItem(findViewById(R.id.menuAdmin), R.drawable.ic_admin_shield, "Quản trị viên", "#166534", "#FFFFFF", true);

        // System
        setupMenuItem(findViewById(R.id.menuPerms), R.drawable.ic_admin_users, "Phân quyền & nhân sự", "transparent", "#64748B", false);
        setupMenuItem(findViewById(R.id.menuLogs), R.drawable.ic_message, "Nhật ký kiểm duyệt", "transparent", "#64748B", false);
        setupMenuItem(findViewById(R.id.menuConfig), R.drawable.ic_admin_dashboard, "Cấu hình nền tảng", "transparent", "#64748B", false);
        setupMenuItem(findViewById(R.id.menuApi), R.drawable.ic_admin_key, "API & webhooks", "transparent", "#64748B", false);
        setupMenuItem(findViewById(R.id.menuLogout), R.drawable.ic_admin_logout, "Đăng xuất", "transparent", "#EF4444", false);
        ...
        // Listeners
        findViewById(R.id.menuLogout).setOnClickListener(v -> Toast.makeText(this, "Đăng xuất thành công", Toast.LENGTH_SHORT).show());
    }

    private void setupMenuItem(View view, int iconRes, String label, String bgColor, String iconColor, boolean isCurrent) {
